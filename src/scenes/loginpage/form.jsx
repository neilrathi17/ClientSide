...
import {
    Box,Button,TextField,useMediaQuery,Typography,useTheme} from "@mui/material"
...
const Form=()=>{
    ...
    const register = async(values,onSubmitProps)=>{
        ...
        formData.append('picturePath',values.pictures.name);
                    ...
                    <Box display="grid" gap="30px" gridTemplateColumns="repeat(4,minmax(0,1fr))" sx={{"&>div":{gridColumn:isNonMobile?undefined:"span 4"}}}>
                      ...
                      <TextField
                        ...
                        <Box>
                            ...
                            <Typography onClick={()=>{
                                setPageType(isLogin?"regoister":"login")
                                resetForm()
                            }}
                            sx={{
                            ...
                            >
                                {isLogin?"Don't have an account? Sign Up here":"Already have an acccount?Login here."}
                            </Typography>
                        </Box>
                </Form>
            )}
